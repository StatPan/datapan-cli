...
func TestRemainingLinkDetailAdaptersVerifyHTMLLandingPageWithoutAuth(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			provider: "kisti",
			host:     "scienceon.kisti.re.kr",
			endpoint: "https://scienceon.kisti.re.kr/api/example",
			adapter:  NewKISTIAdapter(),
		},
		{
			name:     "kisti-ntis",
			provider: "kisti",
			host:     "www.ntis.go.kr",
			endpoint: "https://www.ntis.go.kr/api/example",
			adapter:  NewKISTIAdapter(),
		},
		{
			name:     "kisti-aida",
			provider: "kisti",
			host:     "aida.kisti.re.kr",
			endpoint: "https://aida.kisti.re.kr/api/example",
			adapter:  NewKISTIAdapter(),
		},
		{
			name:     "kipris-plus",
		...
		},
		{
			name:     "koroad",
			provider: "koroad",
			host:     "opendata.koroad.or.kr",
			endpoint: "https://opendata.koroad.or.kr/api/example",
			adapter:  NewKOROADAdapter(),
		},
		{
			name:     "iwest",
			provider: "iwest",
		...
		},
		{
			...
			provider: "nrf",
			host:     "www.kci.go.kr",
			endpoint: "https://www.kci.go.kr/api/example",
			adapter:  NewNRFAdapter(),
		},
		{
			name:     "nrf-krm",
			provider: "nrf",
			host:     "www.krm.or.kr",
			endpoint: "https://www.krm.or.kr/api/example",
			adapter:  NewNRFAdapter(),
		},
		{
			name:     "tashu",
...
func TestRemainingLinkDetailAdaptersFailNonOKLandingPage(t *testing.T) {
	cases := []struct {
		...
		{name: "koroad", provider: "koroad", endpoint: "https://opendata.koroad.or.kr/api/missing", adapter: NewKOROADAdapter()},
		...
		{name: "nrf-kci", provider: "nrf", endpoint: "https://www.kci.go.kr/api/missing", adapter: NewNRFAdapter()},
		{name: "nrf-krm", provider: "nrf", endpoint: "https://www.krm.or.kr/api/missing", adapter: NewNRFAdapter()},
