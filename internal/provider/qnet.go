...
func DefaultRegistry() (Registry, error) {
	return NewRegistry(NewAirportAdapter(), NewAndongAdapter(), NewEKAPEAdapter(), NewEPostAdapter(), NewFolkAdapter(), NewForestAdapter(), NewGeojeAdapter(), NewItfindAdapter(), NewJeonjuAdapter(), NewQNetAdapter(), NewSisulAdapter(), NewUiryeongAdapter(), NewUlsanAdapter())
}
