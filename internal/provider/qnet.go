...
func DefaultRegistry() (Registry, error) {
	return NewRegistry(NewAirportAdapter(), NewAndongAdapter(), NewDataGGAdapter(), NewEKAPEAdapter(), NewEMuseumAdapter(), NewEPostAdapter(), NewFolkAdapter(), NewForestAdapter(), NewGBLibAdapter(), NewGeojeAdapter(), NewGwanakAdapter(), NewHumetroAdapter(), NewItfindAdapter(), NewJejuAdapter(), NewJeonjuAdapter(), NewKoradAdapter(), NewKPXAdapter(), NewLHEBidAdapter(), NewMyHomeAdapter(), NewNAQSAdapter(), NewNFQSAdapter(), NewNongsaroAdapter(), NewOneclickLawAdapter(), NewPQISAdapter(), NewQNetAdapter(), NewSeoulBusAdapter(), NewSisulAdapter(), NewTourAdapter(), NewUiryeongAdapter(), NewUlsanAdapter())
}
