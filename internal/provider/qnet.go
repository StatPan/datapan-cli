...
func DefaultRegistry() (Registry, error) {
	return NewRegistry(NewAirportAdapter(), NewEKAPEAdapter(), NewEPostAdapter(), NewFolkAdapter(), NewForestAdapter(), NewGeojeAdapter(), NewJeonjuAdapter(), NewQNetAdapter(), NewSisulAdapter(), NewUiryeongAdapter(), NewUlsanAdapter())
}
