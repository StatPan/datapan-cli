...
func DefaultRegistry() (Registry, error) {
	return NewRegistry(NewAirportAdapter(), NewAndongAdapter(), NewCultureAdapter(), NewDataGGAdapter(), NewEKAPEAdapter(), NewEMuseumAdapter(), NewEPostAdapter(), NewEShareAdapter(), NewFolkAdapter(), NewForestAdapter(), NewGarakAdapter(), NewGBLibAdapter(), NewGeojeAdapter(), NewGwanakAdapter(), NewHappySDAdapter(), NewHumetroAdapter(), NewI815Adapter(), NewItfindAdapter(), NewJejuAdapter(), NewJeonjuAdapter(), NewKoradAdapter(), NewKPXAdapter(), NewLHEBidAdapter(), NewMAFRAAdapter(), NewMyHomeAdapter(), NewNAQSAdapter(), NewNCPMSAdapter(), NewNFQSAdapter(), NewNongsaroAdapter(), NewOneclickLawAdapter(), NewPQISAdapter(), NewQNetAdapter(), NewSafetyDataAdapter(), NewSafeMapAdapter(), NewSeoulBusAdapter(), NewSeoulOpenDataAdapter(), NewSisulAdapter(), NewTourAdapter(), NewUiryeongAdapter(), NewUlsanAdapter(), NewWork24Adapter())
}
