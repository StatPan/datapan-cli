...
func DefaultRegistry() (Registry, error) {
	return NewRegistry(NewAirportAdapter(), NewAndongAdapter(), NewEKAPEAdapter(), NewEPostAdapter(), NewFolkAdapter(), NewForestAdapter(), NewGeojeAdapter(), NewHumetroAdapter(), NewItfindAdapter(), NewJeonjuAdapter(), NewKoradAdapter(), NewLHEBidAdapter(), NewNAQSAdapter(), NewOneclickLawAdapter(), NewQNetAdapter(), NewSisulAdapter(), NewTourAdapter(), NewUiryeongAdapter(), NewUlsanAdapter())
}
