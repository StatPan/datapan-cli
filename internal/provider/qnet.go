...
func DefaultRegistry() (Registry, error) {
	return NewRegistry(NewAirportAdapter(), NewAndongAdapter(), NewEKAPEAdapter(), NewEPostAdapter(), NewFolkAdapter(), NewForestAdapter(), NewGeojeAdapter(), NewHumetroAdapter(), NewItfindAdapter(), NewJeonjuAdapter(), NewKoradAdapter(), NewNAQSAdapter(), NewOneclickLawAdapter(), NewQNetAdapter(), NewSisulAdapter(), NewTourAdapter(), NewUiryeongAdapter(), NewUlsanAdapter())
}
